        ...
        <ul>
          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                <li>
                  <a href="{{url('/show_all_user')}}">Show Users
                    <span class="badge badge-pill badge-success">Pro</span>
                  </a>
                </li>
                <li>
                  <a href="{{url('/create_user_admin_or_company')}}">Add User </a>
                  @csrf
                </li>
                <li>
   ...
   <main class="page-content">
    <div class="container-fluid">
      ...
      <footer class="text-center">
        <div class="mb-2">
          <small>
            © 2021 made with <i class="fa fa-heart" style="color:red"></i> by - <a target="_blank" rel="noopener noreferrer" href="https://azouaoui.netlify.com">
              Elh@m & hend Team
            </a>
          </small>
        </div>
